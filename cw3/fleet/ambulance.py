...
class Ambulance:
    ...
    def distance_to_incident(self, incident):
        x=self.location[0]-incident.location[0]
        y=self.location[1]-incident.location[1]
        dist=math.sqrt(x**2+y**2)
        print(f'Distance to incident {incident.id} ({incident.description}): {dist}')
